...
training = pd.read_csv('app/app/Data/Training.csv')
testing= pd.read_csv('app/app/Data/Testing.csv')
...
def getDescription():
    ...
    with open('app/app/MasterData/symptom_Description.csv') as csv_file:
...
def getSeverityDict():
    ...
    with open('app/app/MasterData/symptom_severity.csv') as csv_file:
...
def getprecautionDict():
    ...
    with open('app/app/MasterData/symptom_precaution.csv') as csv_file:
...
def sec_predict(symptoms_exp):
    df = pd.read_csv('app/app/Data/Training.csv')
    X = df.iloc[:, :-1]
    y = df['prognosis']
